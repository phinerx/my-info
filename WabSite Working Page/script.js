class TextScramble {
  constructor(el) {
      this.el = el;
      this.chars = 'md(&🙀%jaka🙀ria👚#$fiadashajiku#@!)(&asha';
...
const phrases = [
  ...
  'Our crime is judging people by what they say and think, not by what they look like.',
  'Our crime is outsmarting you, something you will never forgive us for.',
